$.fn.isInViewport=function(){var elementTop=$(this).offset().top;var elementBottom=elementTop+$(this).outerHeight();var viewportTop=$(window).scrollTop();var viewportBottom=viewportTop+$(window).height();return elementBottom>viewportTop&&elementTop<viewportBottom};function circleBar(){var circleBarDOM=undefined;var circleDOM=$('<div class="bgBar"></div><svg class="circle"><circle class="bgBar"/><circle class="bar"/></svg>');var barDOM=circleDOM.find(".bar");var bgBarDOM=circleDOM.find(".bgBar");var infosCtner=$('<div class="infos-ctner"></div>');var pourcDOM=$('<div class="pourcentage"></div>');var textDOM=$('<div class="text"></div>');var value=0;var transition={bar:[],bgBar:[]};var opts={lineColor:"#307bbb",lineWidth:"10",diameter:"100",lineTransitionHover:"500ms",viewPourcentage:!0};function createCircleBar(_elem,_opts,_value){circleBarDOM=$(_elem);circleBarDOM.empty();value=_value;$.extend(opts,_opts);circleBarDOM.addClass("circle-bar");createCircle();createInfosCtner()}
...
function initHover(){circleBarDOM.hover(function(){barDOM.css("stroke-width",opts.lineWidthHover);bgBarDOM.css("stroke-width",opts.bgLineWidthHover);textDOM.css(opts.textHoverCSS);pourcDOM.css(opts.pourcentageHoverCSS)},function(){barDOM.css("stroke-width",opts.lineWidth);bgBarDOM.css("stroke-width",opts.bgLineWidth);textDOM.css(opts.textCSS);pourcDOM.css(opts.pourcentageCSS)})}
